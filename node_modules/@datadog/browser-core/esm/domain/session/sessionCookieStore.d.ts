...
export declare function persistSessionCookie(session: SessionState, options: CookieOptions): void;
export declare function toSessionString(session: SessionState): string;
export declare function retrieveSessionCookie(): SessionState;
export declare function deleteSessionCookie(options: CookieOptions): void;
export {};
